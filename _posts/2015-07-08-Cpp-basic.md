...
4个C++关键词: bool true false wchar\_t typeid typeinfo
...
## C++函数
1个C关键词: return
C++关键词: inline template typename export

[typename](https://zh.wikipedia.org/wiki/Typename)

## C++类
C++关键词: class private public protected this friend virtual operator mutable explicit
