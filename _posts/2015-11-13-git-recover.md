...
今天为了更新Gitcafe, 因为Gitcafe没有办法删除网上的远程分支, 只能借git的`git push origin :master`来实现...谁知道一个不小心在github博客上运行了...一上去发现全没了......整个master分支和仓库全没了.......T_T. 马上把整个本地文件夹复制到别的地方, 重新克隆过来赶紧push到master去..然后发现...删的时候和本地
