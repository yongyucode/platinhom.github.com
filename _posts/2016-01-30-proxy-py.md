...
date: 2016-01-30 04:04:45
categories: Coding
tags: Python Internet
---

代理我就不介绍了..代理简介和类型可以参考[proxy代理类型:透明代理 匿名代理 混淆代理和高匿代理](/2016/01/21/proxy-type/). 这里写一些python爬虫使用代理的知识, 还有一个代理池的类. 附带一些看到的帖子中用urllib构建的示例.
