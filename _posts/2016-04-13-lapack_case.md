...
[Example Programs for LAPACK](http://people.sc.fsu.edu/~jburkardt/f_src/lapack_examples/lapack_examples.html)
...
用的是下面的代码进行测试(网上给的可能会有错). BLAS对下面代码也是需要的. 否则报错如``dpbtrf.f:(.text+0x78e): undefined reference to `dtrsm_`.``
